  ...
  return (
    <main style={{ minHeight: '100vh', background: '#050508', color: '#e4e4e7', fontFamily: 'Inter, sans-serif' }}>
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '56px 24px 80px' }}>
        ...
        <h1 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 'clamp(28px, 5vw, 38px)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.15, margin: '20px 0 10px', color: '#f4f4f5' }}>
          List a contest. Free, always.
        </h1>
        <p style={{ fontSize: 15, lineHeight: 1.65, color: '#a1a1aa', margin: '0 0 32px' }}>
          ...
          Organizers can also <Link href="/feature" style={{ color: '#a5b4fc' }}>feature a listing</Link> once it is live.
        </p>
        <SubmitForm />
      </div>
    </main>
